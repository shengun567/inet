...
#include "inet/protocol/SendWithProtocol.h"

namespace inet {

Define_Module(SendWithProtocol);

void SendWithProtocol::handleMessage(cMessage *message)
{
...
void SendWithProtocol::confirm(Packet *packet, bool successful)
{
}
